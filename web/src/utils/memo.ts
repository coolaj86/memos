...
export const VISIBILITY_OPTIONS: readonly VisibilityOption[] = [
  { value: Visibility.PRIVATE, name: "PRIVATE", labelKey: "memo.visibility.private", descriptionKey: "memo.visibility.private-description", icon: LockIcon, requiresSpace: false, requiresPublicSite: false },
  { value: Visibility.SPACE, name: "SPACE", labelKey: "memo.visibility.space", descriptionKey: "memo.visibility.space-description", icon: UserLockIcon, requiresSpace: true, requiresPublicSite: false },
  { value: Visibility.PUBLIC, name: "PUBLIC", labelKey: "memo.visibility.public", descriptionKey: "memo.visibility.public-description", icon: Globe2Icon, requiresSpace: false, requiresPublicSite: true },
  { value: Visibility.UNLISTED, name: "UNLISTED", labelKey: "memo.visibility.unlisted", descriptionKey: "memo.visibility.unlisted-description", icon: LinkIcon, requiresSpace: false, requiresPublicSite: false },
  { value: Visibility.PROTECTED, name: "PROTECTED", labelKey: "memo.visibility.protected", descriptionKey: "memo.visibility.protected-description", icon: UsersIcon, requiresSpace: false, requiresPublicSite: false },
];
