...
export type IdentityProvider = Message<"memos.api.v1.IdentityProvider"> & {
  ...
  /**
   * Optional. Regular expression applied to the selected upstream claim.
   *
...
export type OAuth2Config = Message<"memos.api.v1.OAuth2Config"> & {
  ...
  /**
   * Optional. Upstream claim used by identifier_filter. Empty means the mapped external ID.
   *
   * @generated from field: string identifier_filter_field = 8;
   */
