...
type OAuth2Config struct {
	...
	IdentifierFilterField string `protobuf:"bytes,8,opt,name=identifier_filter_field,json=identifierFilterField,proto3" json:"identifier_filter_field,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *OAuth2Config) GetIdentifierFilterField() string {
	if x != nil {
		return x.IdentifierFilterField
	}
	return ""
}
...
const file_api_v1_idp_service_proto_rawDesc = "" +
	...
	"\busername\x18\x05 \x01(\tR\busername\"\xc2\x02\n" +
	...
	"\rfield_mapping\x18\a \x01(\v2\x1a.memos.api.v1.FieldMappingR\ffieldMapping\x12;\n" +
	"\x17identifier_filter_field\x18\b \x01(\tB\x03\xe0A\x01R\x15identifierFilterField\"\x1e\n" +
